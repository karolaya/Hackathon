...
cc.execute('''CREATE TABLE IF NOT EXISTS students
             (id PRIMARY KEY AUTOINCREMENT, identification INTEGER, nombre VARCHAR, institution_id INTEGER,
             nota9a FLOAT, nota9e FLOAT, nota10a FLOAT,nota10e FLOAT, nota11a FLOAT, nota11e FLOAT, icfes FLOAT,
...
for i in range(1000):
    if i < 250:
        ...
        nota9a.append(giveItToMe(random.uniform(4.0, 4.2)))
        ...
        icfes.append(giveItToMe(random.uniform(3.0, 4.3)))
        nota9a.append(giveItToMe(random.uniform(3.5, 4.0)))
        ...
        icfes.append(giveItToMe(random.uniform(3.5, 4.6)))
        ...
        icfes.append(giveItToMe(random.uniform(3.2, 4.8)))
...
cc.executemany('INSERT INTO students VALUES (?,?,?,?,?,?,?,?,?,?,?,?)', data)
