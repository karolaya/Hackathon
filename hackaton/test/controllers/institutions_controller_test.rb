...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { ciudad: @institution.ciudad, estrato: @institution.estrato, nombre: @institution.nombre, tipo: @institution.tipo } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { ciudad: @institution.ciudad, estrato: @institution.estrato, nombre: @institution.nombre, tipo: @institution.tipo } }
